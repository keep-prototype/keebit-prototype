...
export const Home = () => {
    ...
    return (
        <main className={`flex flex-col items-center overflow-x-hidden w-screen h-screen pt-35 bg-image transition-all ${opacity}`}>
            <div> 
                <section className="mb-7">
                    <h1 className="logo-font text-main-white font-semibold text-3xl text-center p-3">KEEBIT</h1>
                    <p className="font-light text-md text-center p-1 px-6 text-main-white">우리의 서비스를 통해 아파트 커뮤니티의 모든 예약을 쉽게 관리하세요.</p>
                </section>
            ...
            <div className="flex flex-col items-center">
                <section className="w-screen flex flex-col justify-center items-center gap-8">
                    ...
                    <button className="py-3 px-10 text-center text-sm bg-main-orange border-0 rounded-sm"
                        ...
                        <div className="w-screen flex items-center gap-5">
                            <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                                <g fill="none" fillRule="evenodd">
                                    <circle fill="#FED2C5" className="fill-bg-light" cx="20" cy="20" r="20"></circle>
                                    <path fill="#EB512F" className="fill-main" d="M28.686 14.008l-9 9.085-3.6-3.6-1.2 1.2 4.8 4.8L29.97 15.208z"></path>
                                    <path d="M25.086 16.208l-1.2-1.2-5.4 5.4 1.2 1.2 5.4-5.4zM11 20.693l4.8 4.8 1.2-1.2-4.8-4.8-1.2 1.2z" fill="#00396B" className="fill-secondary" fillRule="nonzero"></path>
                                </g>
                            </svg>
                            <p className="font-semibold text-xs text-main-white">HOW TO MAKE A RESERVATION?</p>
                        </div>
                        <p className="w-screen flex text-main-orange text-sm gap-1.5">질문하기 <span className="text-main-orange font-light">&rarr;</span></p>
                    </div>    
            ...
            <footer className="w-screen flex flex-col items-center justify-center">
                ...
                <section className='w-screen flex gap-2 px-5 pb-5'>
                    <a className='invert brightness-60'>
                        <img src="https://cdn.unicornplatform.com/static/img/icons/social/white/facebook.svg" alt="페이스북아이콘" />
                    </a>
                    <a className='invert brightness-60'>
                        <img src="https://cdn.unicornplatform.com/static/img/icons/social/white/x.svg" alt="트위터아이콘" />
                    </a>
                    <a className='w-5 h-5 invert brightness-60'>
                        <img src="https://cdn.unicornplatform.com/static/img/icons/social/white/instagram.svg" alt="인스타그램아이콘" />
                    </a>
                </section>
            </footer>
