...
export const Home = () => {
  ...
  // }
    ...
    return (
        <main className="flex flex-col items-center w-screen h-screen pt-35">
            <div> 
                        ...
                        <div className="w-screen flex items-center gap-3">
                            <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                                <g fill="none" fill-rule="evenodd">
                                    <circle fill="#FED2C5" class="fill-bg-light" cx="20" cy="20" r="20"></circle>
                                    <path fill="#EB512F" class="fill-main" d="M28.686 14.008l-9 9.085-3.6-3.6-1.2 1.2 4.8 4.8L29.97 15.208z"></path>
                                    <path d="M25.086 16.208l-1.2-1.2-5.4 5.4 1.2 1.2 5.4-5.4zM11 20.693l4.8 4.8 1.2-1.2-4.8-4.8-1.2 1.2z" fill="#00396B" class="fill-secondary" fill-rule="nonzero"></path>
                                </g>
                            </svg>
                            <p className="font-semibold text-xs">HOW TO MAKE A RESERVATION?</p>
                        </div>
